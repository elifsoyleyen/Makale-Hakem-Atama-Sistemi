        ...
        <!-- Masthead-->
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                   ...
                   <form action="sifredegistiryazar_islem.jsp">
										  <label>Yeni Þifre</label>
										   &nbsp;  &nbsp;  &nbsp;   &nbsp;   &nbsp;   &nbsp;   &nbsp;   &nbsp;   &nbsp; 
										  <input type="password" id="yazaryenisf" name="aa" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"><br><br>
										  
										  <label >Yeni Þifre Tekrar</label>
										  &nbsp; 
										  <input type="password" id="yazaryenisft" name="bb"  ><br><br>
										   <button type="submit" class="btn btn-success">Þifremi Güncelle</button>
										  </form>
