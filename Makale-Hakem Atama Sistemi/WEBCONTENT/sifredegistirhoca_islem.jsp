...
int id=Integer.parseInt(String.valueOf(session.getAttribute("idhoca")));
System.out.println(id);
		ResultSet rs=islemler.selectDatahoca(id);
		if(rs.next()){			
			...
			boolean islemSonucu=islemler.guncellehocasifre(sayiNesnesi,id);
				if (islemSonucu==true){
					out.println("Editor Şifre Güncelleme İşlemi kaydedilmiştir...");			
					 response.sendRedirect("sifredegistirhoca.jsp"); 
