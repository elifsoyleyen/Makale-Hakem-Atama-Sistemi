                ...
                <div class="row">
                    <div class="col-lg-6">
                                                    ...
                                                    <div class="card-header">
                                                        <strong>Hoca Ekleme Sayfası</strong> 
                                                    </div>
                                                    <div class="card-body card-block">
                                                      <form action="hocaekleeditor_islem.jsp" method="post">
                                                          
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label"></label>Hoca Kullanıcı Adı</div>
                                                                <div class="col-12 col-md-9">
                                                                <input type="text" name="hocaka" id="hocaka" class="form-control"><small class="form-text text-muted"></small></div>
                                                            </div>
                                                              <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label"></label>Hoca Şifre</div>
                                                                <div class="col-12 col-md-9">
                                                                <input type="password" name="hocasf" id="hocasf"  class="form-control"><small class="form-text text-muted"></small></div>
                                                            </div>
                                                              <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label"></label>Hoca Ad Soyad</div>
                                                                <div class="col-12 col-md-9">
                                                                <input type="text" name="hocaadsoyad" id="hocaadsoyad"  class="form-control"><small class="form-text text-muted"></small></div>
                                                            </div>
                                                           
                                                              <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label"></label>Hoca Mail</div>
                                                                <div class="col-12 col-md-9">
                                                                <input type="text" name="hocamail" id="hocamail"  class="form-control"><small class="form-text text-muted"></small></div>
                                                            </div>
                                                            
                                                              <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label"></label>Hoca Telefon</div>
                                                                <div class="col-12 col-md-9">
                                                                <input type="text" name="hocatel" id="hocatel"  class="form-control"><small class="form-text text-muted"></small></div>
                                                            </div>
