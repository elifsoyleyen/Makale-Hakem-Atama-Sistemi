...
<body>
  ...
  <header id="header" class="header">
        ...
        <form action=aratur.jsp method="post">
           <select id="selectBox" onchange="populateCustomerId();" class="">
                                                                   
                                                                           <% 		
																		ResultSet rss=sayiCrud.listeletur();
																	  	while(rss.next()) 
																	  	{ %> 
																	  <option  value="<%=rss.getInt("idtur")%>" ><%=rss.getString("turadi")%></option>
                                                                       ...
                                                                       <button type="submit" name="save" class="btn btn-primary">Search</button>
                                                                           <input id="customerId" name="aa" type="text" value="" />
