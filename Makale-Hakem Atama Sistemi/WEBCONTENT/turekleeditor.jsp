                ...
                <div class="row">
                    <div class="col-lg-6">
                                                    ...
                                                    <div class="card-header">
                                                        <strong>Tür Ekleme Sayfası</strong> 
                                                    </div>
                                                    <div class="card-body card-block">
                                                      <form action="turekleeditor_islem.jsp" method="post">
                                                         
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label"></label>Tür Adı</div>
                                                                <div class="col-12 col-md-9">
                                                                <input type="text" name="turadi" id="turadi" placeholder="Text" class="form-control"><small class="form-text text-muted"></small></div>
                                                            </div>
