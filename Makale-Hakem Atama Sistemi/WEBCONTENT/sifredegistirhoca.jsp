...
<head>
    ...
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800' rel='stylesheet' type='text/css'>
     ...
     <%
					...
					int ideditor=Integer.parseInt(String.valueOf(session.getAttribute("idhoca")));
					%>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                           <form action="sifredegistirhoca_islem.jsp">
						   <div class="form-group">
						    <label for="exampleInputPassword1">Yeni Şifre</label>
						    <input type="password" class="form-control" id="hocayenisifre" name="aa" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}">
						  </div>
						  <div class="form-group">
						    <label for="exampleInputPassword1">Yeni Şifre Tekrar</label>
						    <input type="password" class="form-control" id="hocayenisifret" name="bb" placeholder="Password">
						  </div>
